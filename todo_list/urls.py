...
from .views import AnnouncementsView,TodoDetailView,TodoUpdateView,TodoDeleteView,UserTodoListView,LowTodoUpdateView,OfficerTodoListView,AnnouncementoCreateView,AnnouncementDeleteView
from . import views
urlpatterns = [
    ...
    path('todo_list/<int:pk>/', TodoDetailView.as_view(), name='task-detail'),
